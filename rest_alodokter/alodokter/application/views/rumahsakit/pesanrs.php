			...
			<div class="container">
				<div class="row">
					<div class="col text-center">
						<div class="section_title">PESAN RUMAH SAKIT</div>
					</div>
				</div>
				<br><br>
				<div  style="color: black;">
					<?php echo $this->session->flashdata('hasil'); ?>
					<?php echo form_open('C_pesanrs/insert');?>
					<?php echo form_hidden('id_rs', $rumahsakit[0]->id_rs);?>
					<?php echo form_hidden('id_pesanrs', $rumahsakit1);?>
					...
					<table class="table table-bordered table-striped table-hover" style="width: 60%;" align="center">
						<tr>
							<td>ID PESAN RS</td>
							<td><?php echo form_input('', $rumahsakit1,"disabled");?></td>
						</tr>
						<tr>
							<td>ID RS</td>
						...
						<tr>
							<td>WAKTU</td>
							<td><?php echo form_input('waktu_pesan');?></td>
						</tr>
							<tr>
							<td colspan="2">
