	...
	<div class="menu trans_500">
		<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
			...
			<ul>
				...
				<li class="menu_item"><a href="<?php echo base_url('C_dashboard'); ?>">News</a></li>
										...
										<div class="header_nav_content d-flex flex-row align-items-center justify-content-start">
											<nav class="main_nav">
												<ul class="d-flex flex-row align-items-center justify-content-start">
													...
													<li class="active"><a href="<?php echo base_url('C_dashboard'); ?>">Services</a></li>
													<li><a href="<?php echo base_url('C_news'); ?>">News</a></li>
													<li><a href="<?php echo base_url('C_dashboard'); ?>">Contact</a></li>
												</ul>
											</nav>
						...
						<div class="footer_bar_content d-flex flex-sm-row flex-column align-items-lg-center align-items-start justify-content-start">
							<nav class="footer_nav">
								<ul class="d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
									...
									<li><a href="<?php echo base_url('C_dashboard'); ?>">About Us</a></li>
									<li><a href="<?php echo base_url('C_services'); ?>">Services</a></li>
									<li><a href="<?php echo base_url('C_dashboard'); ?>">News</a></li>
									<li><a href="<?php echo base_url('C_dashboard'); ?>">Contact</a></li>
								</ul>
							</nav>
