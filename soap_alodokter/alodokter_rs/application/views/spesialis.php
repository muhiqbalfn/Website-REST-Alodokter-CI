		...
		<div class="menu trans_500">
			<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
				...
				<ul>
					...
					<li class="menu_item"><a href="<?php echo base_url('C_rumahsakit'); ?>">Rumah Sakit</a></li>
					<li class="menu_item"><a href="<?php echo base_url('C_pesanrs'); ?>">PESANAN RS</a></li>
					...
					<div class="dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							<a class="dropdown-item" href="<?php echo base_url('C_karyawan'); ?>">Karyawan</a>
							<a class="dropdown-item" href="<?php echo base_url('C_spesialis'); ?>">Spesialis</a>
							<a class="dropdown-item" href="<?php echo base_url('C_dokter'); ?>">Dokter</a>
							<a class="dropdown-item" href="<?php echo base_url('C_pasien'); ?>">Pasien</a>
						</div>
					</div>
				</ul>
			</div>
										...
										<div class="header_top_extra d-flex flex-row align-items-center justify-content-start ml-auto">
											<div class="header_top_nav">
												<ul class="d-flex flex-row align-items-center justify-content-start">
													...
													<li><a href="<?php echo base_url('C_login/logout'); ?>" class="btn btn-outline-success btn-sm" role="button" aria-pressed="true">Log Out</a></li>
											...
											<div class="header_nav_content d-flex flex-row align-items-center justify-content-start">
												<nav class="main_nav">
													<ul class="d-flex flex-row align-items-center justify-content-start">
														...
														<li class="active"><a href="<?php echo base_url('C_rumahsakit'); ?>">Rumah Sakit</a></li>
					...
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">Spesialis</div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col text-center">
						<div class="section_title">LIST OF THE SPESIALIS</div>
					</div>
				</div>
				<br><br>
				<div  style="color: black;">
					...
					<center>
						<table style="width: 70%;" class="table table table-striped table-hover table-success">
							...
							<?php
							if (is_array($spesialis) || is_object($spesialis))
							{
								foreach ($spesialis as $rs)
								{
									echo "<tr>
									<td>$rs->id</td>
									<td>$rs->nama</td>
