				...
				<ul>
					...
					<div class="dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							<a class="dropdown-item" href="<?php echo base_url('C_obat'); ?>">Obat</a>
							<a class="dropdown-item" href="<?php echo base_url('C_penyakit'); ?>">Penyakit</a>
							<a class="dropdown-item" href="<?php echo base_url('C_tindakanMedis'); ?>">Tindakan Medis</a>
						</div>
					</div>
				</ul>
			</div>
					...
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">Tindakan Medis</div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col text-center">
						<div class="section_title">LIST OF THE CURE ACTION</div>
					</div>
				</div>
				<br><br>
				<div  style="color: black;">
					...
					<center>
						<table style="width: 70%;" class="table table table-striped table-hover table-success">
							...
							<?php
							if (is_array($tindakan) || is_object($tindakan))
							{
								foreach ($tindakan as $rs)
								{
									echo "<tr>
									<td>$rs->id</td>
									<td>$rs->nama</td>
