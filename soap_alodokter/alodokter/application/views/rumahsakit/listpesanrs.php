							...
							<tbody>
								<?php foreach ($pesan_rs as $key => $rs): ?>
									<tr>
										...
										<td>
											<a href="<?php echo base_url('C_pesanrs/update/'.$rs->id_pesanrs) ?>" class="btn btn-sm btn-success">Edit</a>
											<a href="<?php echo base_url('C_pesanrs/delete/'.$rs->id_pesanrs) ?>" class="btn btn-sm btn-danger">Batal</a>
										</td>
									</tr>
								<?php endforeach ?>
							</tbody>
